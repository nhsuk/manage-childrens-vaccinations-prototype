...
const realisticAnswers = {
  ...
  anemia: {
    ...
    triageNote: 'Spoke with parent, child diagnosed with anemia and takes iron supplements. Vaccinator needs to be aware and ensure iron levels are monitored during and after vaccine administration.'
  },
  adhd: {
